package com.project.codinviec_core_service.mapper.auth;

import com.project.codinviec_core_service.dto.auth.ProfileDTO;
import com.project.codinviec_core_service.dto.auth.UserDTO;
import com.project.codinviec_core_service.dto.auth.UserReviewDTO;
...
import com.project.codinviec_core_service.request.auth.UpdateProfileRequest;
...
public class UserMapper {
    ...
    public User createdRegisterUserToUser(CreateUserCorePayload createUserCorePayload, Role role){
        return User.builder()
                .id(createUserCorePayload.getId())
                .firstName(createUserCorePayload.getFirstName())
                .lastName(createUserCorePayload.getLastName())
                .email(createUserCorePayload.getEmail())
                .password(createUserCorePayload.getPassword())
                .isBlock(createUserCorePayload.getIsBlock())
                .avatar(createUserCorePayload.getAvatar())
                .createdDate(createUserCorePayload.getCreatedDate())
                .updatedDate(createUserCorePayload.getUpdatedDate())
                .role(role)
                .company(null)
                .isFindJob(false)
                .isBlock(false)
